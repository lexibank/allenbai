...
- [Wordlist: CLDF dataset derived from Allen's "Bai Dialect Survey" from 2007](#ds-cldfmetadatajson)
- [StructureDataset: CLDF dataset derived from Allen's "Bai Dialect Survey" from 2007](#ds-structuredatasetmetadatajson)
...
[prov:wasGeneratedBy](http://www.w3.org/ns/prov#wasGeneratedBy) | <ol><li><strong>lingpy-rcParams</strong>: <a href="./lingpy-rcParams.json">lingpy-rcParams.json</a></li><li><strong>python</strong>: 3.14.4</li><li><strong>python-packages</strong>: <a href="./requirements.txt">requirements.txt</a></li></ol>
...
[dc:extent](http://purl.org/dc/terms/extent) | 500
...
## <a name="table-soundtable"></a>Table [SoundTable](./SoundTable)
...
`Form_IDS` | list of `string` (separated by ` `) | 
`Forms` | `integer` | 
...
[dcat:accessURL](http://www.w3.org/ns/dcat#accessURL) | https://github.com/lexibank/allenbai
[prov:wasDerivedFrom](http://www.w3.org/ns/prov#wasDerivedFrom) | <ol><li><a href="https://github.com/lexibank/allenbai/tree/v4.0">lexibank/allenbai v4.0</a></li><li><a href="git@github.com:glottolog/glottolog/tree/v5.2.1">Glottolog v5.2.1</a></li><li><a href="git@github.com:concepticon/concepticon-data/tree/v3.4.0">Concepticon v3.4.0</a></li><li><a href="https://github.com/cldf-clts/clts//tree/v2.3.0">CLTS v2.3.0</a></li></ol>
[prov:wasGeneratedBy](http://www.w3.org/ns/prov#wasGeneratedBy) | <ol><li><strong>python</strong>: 3.14.4</li><li><strong>python-packages</strong>: <a href="./requirements.txt">requirements.txt</a></li></ol>
[rdf:ID](http://www.w3.org/1999/02/22-rdf-syntax-ns#ID) | allenbai
[rdf:type](http://www.w3.org/1999/02/22-rdf-syntax-ns#type) | http://www.w3.org/ns/dcat#Distribution
